...
export class ConferenceApp {
  ...
  loggedInPages: PageInterface[] = [
    ...
    { title: 'Ayuda', name: 'SupportPage', component: SupportPage, icon: 'help' },
    { title: 'Salir', name: 'TabsPage', component: TabsPage, icon: 'log-out', logsOut: true }
  ];
  loggedOutPages: PageInterface[] = [
    { title: 'Cuenta', name: 'LoginPage', component: LoginPage, icon: 'log-in' },
    { title: 'Ayuda', name: 'SupportPage', component: SupportPage, icon: 'help' },
    { title: 'Salir', name: 'SignupPage', component: SignupPage, icon: 'person-add' }
  ];
  rootPage: any;
